        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              {data.personalInfo?.phone && (!isValidPhoneNumber(data.personalInfo.phone) || data.personalInfo.phone.replace(/\D/g, '').length < 10) && (
                <p className="text-xs text-destructive">Please enter a complete valid phone number</p>
              )}
            </div>
            <Button 
              className="w-full mt-6" 
              ...
              disabled={
                ...
                !isValidPhoneNumber(data.personalInfo.phone) ||
                (data.personalInfo.phone.replace(/\D/g, '').length < 10)
              }
